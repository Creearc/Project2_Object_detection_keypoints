"""
+ python train_keypoints.py --training final_annotation.xml --model kplum.dat
+ python train_keypoints.py --training final_annotation_500.xml --model kplum_gen_500.dat
+ python train_keypoints.py --training final_annotation_fixed.xml --model kplum_gen_fix.dat
+ python train_keypoints.py --training final_annotation_fixed.xml --model kplum_gen_fix2.dat
+ python train_keypoints.py --training final_annotation_realsense.xml --model kplum_gen_rs.dat
+ python train_keypoints.py --training final_annotation_first_comb_test.xml --model kplum_gen_first_comb_test.dat
+ python train_keypoints.py --training final_annotation_second_comb_test.xml --model kplum_gen_second_comb_test.dat
+ python train_keypoints.py --training final_annotation_third_comb_test.xml --model kplum_gen_third_comb_test.dat

+ python train_keypoints.py --training final_annotation_fourth_comb_test.xml --model kplum_gen_fourth_comb_test.dat
+ python train_keypoints.py --training final_annotation_fifth_comb_test_(only_camera_flipped1).xml --model kplum_gen_fifth_comb_test.dat

+ python train_keypoints.py --training final_annotation_sixth_comb_test_(only_camera_flipped01).xml --model kplum_gen_sixth_comb_test.dat
python train_keypoints.py --training final_annotation_seventh_comb_test_(flipped01+model).xml --model kplum_gen_seventh_comb_test.dat
+ python train_keypoints.py --training final_annotation_eighth_comb_test_(flipped01+real).xml --model kplum_gen_eighth_comb_test.dat
+ python train_keypoints.py --training final_annotation_ninth_comb_test.xml --model kplum_gen_ninth_comb_test.dat
"""
